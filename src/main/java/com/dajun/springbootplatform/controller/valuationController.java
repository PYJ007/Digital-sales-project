...
public class valuationController {
    ...
    public String saveValuation(Model model, HttpServletRequest request,@RequestParam("file") MultipartFile file){//@RequestParam("file") MultipartFile file
        ...
        valuation valuation = new valuation(seed_id,purity,neatness,germinationrate,wet,rank,grade);
